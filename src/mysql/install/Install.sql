...
INSERT INTO `menuconfig_mcf` ( `name`, `parent`, `ismenu`, `content_english`, `content`, `uri`, `statustext`, `security_grp`, `session_var`, `session_var_in_text`, `session_var_in_uri`, `url_parm_name`, `active`, `sortorder`, `icon`) VALUES
( 'root', '', 1, 'Main', 'Main', '', '', 'bAll', NULL, 0, 0, NULL, 1, 0, NULL),
( 'calendar', 'root', 0, 'Calendario', 'Calendario', 'calendar.php', '', 'bAll', NULL, 0, 0, NULL, 1, 1, 'fa-calendar'),

( 'people', 'root', 1, 'Membros', 'Membros', '', 'Membros', 'bAll', NULL, 0, 0, NULL, 1, 2, 'fa-users'),
( 'membdash', 'people', 0, 'Dashboard', 'Dashboard', 'MembersDashboard.php', '', 'bAddRecords', NULL, 0, 0, NULL, 1, 1, NULL),
( 'newperson', 'people', 0, 'Add Novo Membro', 'Add Novo Membro', 'PersonEditor.php', '', 'bAddRecords', NULL, 0, 0, NULL, 1, 2, NULL),
( 'viewperson', 'people', 0, 'Ver Todos os Membros', 'Ver Todos os Membros', 'SelectList.php?mode=person', '', 'bAll', NULL, 0, 0, NULL, 1, 3, NULL),
( 'newfamily', 'people', 0, 'Add Nova Familia', 'Add Nova Familia', 'FamilyEditor.php', '', 'bAddRecords', NULL, 0, 0, NULL, 1, 4, NULL),
( 'viewfamily', 'people', 0, 'Ver Todas as Famílias', 'Ver Todas as Famílias', 'FamilyList.php', '', 'bAll', NULL, 0, 0, NULL, 1, 5, NULL),

( 'groups', 'root', 1, 'Grupos', 'Grupos', '', '', 'bAll', NULL, 0, 0, NULL, 1, 3, 'fa-tag'),
( 'listgroups', 'groups', 0, 'Listar Grupos', 'Listar Grupos', 'GroupList.php', '', 'bAll', NULL, 0, 0, NULL, 1, 1, NULL),

( 'editgroup', 'groups', 0, 'Editar Tipo de Grupo', 'Editar Tipo de Grupo', 'OptionManager.php?mode=grptypes', '', 'bMenuOptions', NULL, 0, 0, NULL, 1, 3, NULL),
( 'assigngroup', 'groups', 0, 'Ajudante de Assistente de Grupo', 'Ajudante de Assistente de Grupo', 'SelectList.php?mode=groupassign', '', 'bAll', NULL, 0, 0, NULL, 1, 4, NULL),

( 'sundayschool', 'root', 1, 'Escola de domingo', 'Escola de domingo', '', '', 'bAll', NULL, 0, 0, NULL, 1, 4, 'fa-child'),
( 'sundayschool-dash', 'sundayschool', 0, 'Dashboard', 'Dashboard', 'sundayschool/SundaySchoolDashboard.php', '', 'bAll', NULL, 0, 0, NULL, 1, 2, NULL),

( 'mailchimp', 'root', 0, 'E-Mail', 'E-Mail', 'mailchimp/MailChimpDashboard.php', '', 'bAll', NULL, 0, 0, NULL, 1, 5, 'fa-envelope'),

( 'events', 'root', 1, 'Eventos', 'Eventos', '', 'Eventos', 'bAll', NULL, 0, 0, NULL, 1,6, 'fa-ticket'),
( 'listevent', 'events', 0, 'Lista de Eventos da Igreja', 'Lista de Eventos da Igreja', 'ListEvents.php', 'List Church Events', 'bAll', NULL, 0, 0, NULL, 1, 1, NULL),
( 'addevent', 'events', 0, 'Add Evento da Igreja', 'Add Evento da Igreja', 'EventEditor.php', 'Add Church Event', 'bAll', NULL, 0, 0, NULL, 1, 2, NULL),
( 'eventype', 'events', 0, 'Listar Tipos de Evento', 'Listar Tipos de Evento', 'EventNames.php', '', 'bAdmin', NULL, 0, 0, NULL, 1, 3, NULL),
( 'eventcheckin', 'events', 0, 'Check-in e Check-out', 'Check-in e Check-out', 'Checkin.php', '', 'bAll', NULL, 0, 0, NULL, 1, 4, NULL),

( 'deposit', 'root', 1, 'Depósitos', 'Depósitos', '', '', 'bFinance', NULL, 0, 0, NULL, 1, 7, 'fa-bank'),
( 'envelopmgr', 'deposit', 0, 'Envelope Manager', 'Envelope Manager', 'ManageEnvelopes.php', '', 'bAdmin', NULL, 0, 0, NULL, 1, 1, NULL),
( 'newdeposit', 'deposit', 0, 'Create New Deposit', 'Create New Deposit', 'DepositSlipEditor.php?DepositType=Bank', '', 'bFinance', NULL, 0, 0, NULL, 1, 2, NULL),
( 'viewdeposit', 'deposit', 0, 'View All Deposits', 'View All Deposits', 'FindDepositSlip.php', '', 'bFinance', NULL, 0, 0, NULL, 1, 3, NULL),
('depositreport', 'deposit', 0, 'Deposit Reports', 'Deposit Reports', 'FinancialReports.php', '', 'bFinance', NULL, 0, 0, NULL, 1, 4, NULL),
...
('fundraiser', 'root', 1, 'Fundraiser', 'Fundraiser', '', '', 'bAll', NULL, 0, 0, NULL, 1, 8, 'fa-money'),
('viewfundraiser', 'fundraiser', 0, 'View All Fundraisers', 'View All Fundraisers', 'FindFundRaiser.php', '', 'bAll', NULL, 0, 0, NULL, 1, 1, NULL),
('newfundraiser', 'fundraiser', 0, 'Create New Fundraiser', 'Create New Fundraiser', 'FundRaiserEditor.php?FundRaiserID=-1', '', 'bAll', NULL, 0, 0, NULL, 1, 2, NULL),
('editfundraiser', 'fundraiser', 0, 'Edit Fundraiser', 'Edit Fundraiser', 'FundRaiserEditor.php', '', 'bAll', 'iCurrentFundraiser', 1, 1, 'FundRaiserID', 1, 3, NULL),
('viewbuyers', 'fundraiser', 0, 'View Buyers', 'View Buyers', 'PaddleNumList.php', '', 'bAll', 'iCurrentFundraiser', 1, 1, 'FundRaiserID', 1, 4, NULL),
('adddonors', 'fundraiser', 0, 'Add Donors to Buyer List', 'Add Donors to Buyer List', 'AddDonors.php', '', 'bAll', 'iCurrentFundraiser', 1, 1, 'FundRaiserID', 1, 5, NULL),

('report', 'root', 1, 'Data/Reports', 'Data/Reports', '', '', 'bAll', NULL, 0, 0, NULL, 1, 9, 'fa-file-pdf-o'),
('reportmenu', 'report', 0, 'Reports Menu', 'Reports Menu', 'ReportList.php', '', 'bAll', NULL, 0, 0, NULL, 1, 1, NULL),
( 'querymenu', 'report', 0, 'Query Menu', 'Query Menu', 'QueryList.php', '', 'bAll', NULL, 0, 0, NULL, 1, 2, NULL),
( 'cvsexport', 'report', 0, 'CSV Export Records', 'CSV Export Records', 'CSVExport.php', '', 'bAll', NULL, 0, 0, NULL, 1, 3, NULL),

( 'properties', 'root', 1, 'Propriedades', 'Propriedades', '', '', 'bAll', NULL, 0, 0, NULL, 1, 10, 'fa-cogs'),
('peopleproperty', 'properties', 0, 'People Properties', 'People Properties', 'PropertyList.php?Type=p', '', 'bAll', NULL, 0, 0, NULL, 1, 1, NULL),
('familyproperty', 'properties', 0, 'Family Properties', 'Family Properties', 'PropertyList.php?Type=f', '', 'bAll', NULL, 0, 0, NULL, 1, 2, NULL),
('groupproperty', 'properties', 0, 'Group Properties', 'Group Properties', 'PropertyList.php?Type=g', '', 'bAll', NULL, 0, 0, NULL, 1, 3, NULL),
('propertytype', 'properties', 0, 'Property Types', 'Property Types', 'PropertyTypeList.php', '', 'bAll', NULL, 0, 0, NULL, 1, 4, NULL),

('generalsetting', 'admin', 0, 'Editar configurações Gerais', 'Editar configurações Gerais', 'SystemSettings.php', '', 'bAdmin', NULL, 0, 0, NULL, 1, 1, NULL),
('editusers', 'admin', 0, 'Usuários do Sistema', 'Usuários do Sistema', 'UserList.php', '', 'bAdmin', NULL, 0, 0, NULL, 1, 2, NULL),
( 'accessreport', 'admin', 0, 'Relatório de Acesso', 'Relatório de Acesso', 'AccessReport.php', '', 'bAdmin', NULL, 0, 0, NULL, 1, 3, NULL),
('customfamilyfld', 'admin', 0, 'Editar Campos Pesonalizados da Família', 'Editar Campos Pesonalizados da Família', 'FamilyCustomFieldsEditor.php', '', 'bAdmin', NULL, 0, 0, NULL, 1, 5, NULL),
('custompersonfld', 'admin', 0, 'Editar Campos Pesonalizados do Membro', 'Editar Campos Pesonalizados do Membro', 'PersonCustomFieldsEditor.php', '', 'bAdmin', NULL, 0, 0, NULL, 1, 6, NULL),
('donationfund', 'admin', 0, 'Editar Fundos de Doação', 'Editar Fundos de Doação', 'DonationFundEditor.php', '', 'bAdmin', NULL, 0, 0, NULL, 1, 7, NULL),
('dbbackup', 'admin', 0, 'Backup do Banco de Dados', 'Backup do Banco de Dados', 'BackupDatabase.php', '', 'bAdmin', NULL, 0, 0, NULL, 1, 8, NULL),
('dbrestore', 'admin', 0, 'Restaurar Banco de Dados', 'Restaurar Banco de Dados', 'RestoreDatabase.php', '', 'bAdmin', NULL, 0, 0, NULL, 1, 9, NULL),
('cvsimport', 'admin', 0, 'Importar CSV', 'Importar CSV', 'CSVImport.php', '', 'bAdmin', NULL, 0, 0, NULL, 1, 10, NULL),
('seeddata', 'admin', 0, 'Gerar dados de sementes', 'Gerar dados de sementes', 'GenerateSeedData.php', '', 'bAdmin', NULL, 0, 0, NULL, 1, 11, NULL),
('register', 'admin', 0, 'Registro ChurchCRM', 'Atualizar Regfistros da ChurchCRM', 'Register.php', '', 'bAdmin', NULL, 0, 0, NULL, 1, 12, NULL);
